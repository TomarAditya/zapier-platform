...
const baseFlags = {
  format: flags.string({
    ...
    default: 'table',
    description:
      'Changes the way structured data is presented. If "json" or "raw", you can pipe the output of the command into other tools, such as `jq`.'
  }),
  debug: flags.boolean({
    char: 'd',
    description: 'Shows extra debugging output.'
    // pull from env?
  }),
